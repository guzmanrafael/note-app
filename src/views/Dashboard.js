...
import { Layout, Input, Form, Row, Col } from "antd";
import { withRouter } from "react-router";
import { useDispatch, useSelector } from "react-redux";
import "bootstrap/dist/css/bootstrap.min.css";
import { startDeleting, startNewNotes, startSaveNote } from "../actions/notes";
import { useForm } from "../hooks/useForm";
import { Modal, Button, Card, CardDeck, Container } from "react-bootstrap";
        ...
        >
          {notes.length !== 0 ? (
            ...
            <CardDeck className="grid">
              ...
              >
                <Card.Body>
                  <Card.Title>Aun no tienes notas creadas !</Card.Title>
                </Card.Body>
              </Card>
            </CardDeck>
          )}
